...
class TestRegitration:
    ...
    def test_registration_valid_user_data_success_transition_on_login_url(self, driver, driver_registration):
        user_name = driver.find_element(*StellarBurgersLocators.REGISTRATION_NICKNAME)
        user_name.send_keys(DataUser.USER_REG_NAME)

        user_email = driver.find_element(*StellarBurgersLocators.EMAIL)
        ...
        button_registration = driver.find_element(*StellarBurgersLocators.REGISTRATION_BUTTON)
    ...
    def test_registration_password_len_is_less_six_symbols_err_incorrect_password(self, driver, driver_registration):
        user_password = driver.find_element(*StellarBurgersLocators.PASSWORD)
        ...
        p_element_error = driver.find_element(*StellarBurgersLocators.ERROR_PASSWORD_LEN)
